/*
 * <<<<<<< GraphikPanel.java Created on 15.10.2003 $Id: GraphikPanel.java,v 1.4
 * 2003/10/25 14:41:22 jsprenger Exp $ ======= Created on 15.10.2003 $Id:
 * GraphikPanel.java,v 1.8 2003/10/28 21:17:33 moleman Exp $ >>>>>>> 1.5
 */
package gui;
...
public class GraphikPanel extends JPanel {
    ...
    void drawCar(Graphics g, int x, int y) {
        ...
        g.setColor(Color.black);
       // System.out.println("zeichnet Car..." + x + "." + y);
        g.fillRect(
